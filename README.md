...
Download the [latest binary release](https://github.com/step-security/getsentry-craft/releases/latest), or install via npm:
...
jobs:
  changelog-preview:
    uses: step-security/getsentry-craft/.github/workflows/changelog-preview.yml@v2
    secrets: inherit
```
